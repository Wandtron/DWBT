    ...
    <nav class="col-6 align-self-center justify-content-center" id="inhalt">
        <ul class="nav justify-content-center my-1" >
            <li class="nav-item">
                ...
                <a class="nav-link
                @if(strpos($a, 'Start')) disabled @endif" href="Start.php">Startseite </a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if(strpos($a, 'Produkte')) disabled @endif" href="Produkte.php">Mahlzeiten </a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if(strpos($a, '/M2/#')) disabled @endif" href="#">Bestellungen </a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if(strpos($a, '/M2/#')) disabled @endif" href="https://www.fh-aachen.de/studium/informatik-bsc/" target="_blank">FH-Aachen </a>
            </li>
        </ul>
    </nav>
    <div class="col-3 align-self-center">
        <form action="http://www.google.de/search" class="input-group" method="GET" target="_blank" style="margin-bottom: 0px;">
